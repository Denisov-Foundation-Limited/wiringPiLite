...
struct wiringPiNodeStruct
{
    ...
    bool   (*pinMode)          (struct wiringPiNodeStruct *node, int pin, int mode) ;
    bool   (*pinModeRead)      (struct wiringPiNodeStruct *node, int pin, int *mode) ;
    bool   (*pullUpDnControl)  (struct wiringPiNodeStruct *node, int pin, int mode) ;
    bool   (*pullUpDnRead)     (struct wiringPiNodeStruct *node, int pin, int *mode) ;
    bool   (*digitalRead)      (struct wiringPiNodeStruct *node, int pin, int *value) ;
    bool   (*digitalWrite)     (struct wiringPiNodeStruct *node, int pin, int value) ;
    void   (*pwmWrite)         (struct wiringPiNodeStruct *node, int pin, int value) ;
    bool   (*analogRead)       (struct wiringPiNodeStruct *node, int pin, int *value) ;
    bool   (*analogWrite)      (struct wiringPiNodeStruct *node, int pin, int value) ;
...
extern          bool pinMode             (int pin, int mode) ;
extern          bool pinModeRead         (int pin, int *mode) ;
extern          bool pullUpDnControl     (int pin, int pud) ;
extern          bool pullUpDnRead        (int pin, int *pud) ;
extern          bool digitalRead         (int pin, int *value) ;
extern          bool digitalWrite        (int pin, int value) ;
extern unsigned int  digitalRead8        (int pin) ;
extern          void digitalWrite8       (int pin, int value) ;
extern          void pwmWrite            (int pin, int value) ;
extern          bool analogRead          (int pin, int *value) ;
extern          bool analogWrite         (int pin, int value) ;
